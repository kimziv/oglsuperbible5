...
void SetupRC(void)
    ...
    toonShader = gltLoadShaderTripletWithAttributes("GSExplode.vs", "GSExplode.gs", "GSExplode.fs", 2, GLT_ATTRIBUTE_VERTEX, "vVertex",
    ...
    locPushOut = glGetUniformLocation(toonShader, "push_out");
}
