...
void SetupRC(void)
    ...
    toonShader = gltLoadShaderTripletWithAttributes("GSCulling.vs", "GSCulling.gs", "GSCulling.fs", 2, GLT_ATTRIBUTE_VERTEX, "vVertex",
    ...
    locViewpoint = glGetUniformLocation(toonShader, "viewpoint");
